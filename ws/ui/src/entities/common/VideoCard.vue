...
<template>
  <div class="group relative flex flex-col w-full cursor-pointer">
    <!-- Thumbnail -->
    <div class="relative w-full aspect-video overflow-hidden rounded-lg bg-gray-300">
      <img
        :src="thumbnail"
        :alt="title"
        class="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
      >
      <span class="absolute bottom-2 right-2 px-1.5 py-0.5 text-xs bg-black text-white rounded">
        {{ duration }}
      </span>
    </div>
